...
# uv_kpt_ind = np.loadtxt('../data/uv_kpt_ind.txt').astype(np.int32)  # 2 x 68 get kpt
# face_ind = np.loadtxt('../data/face_ind.txt').astype(
#     np.int32)  # get valid vertices in the pos map
# triangles = np.loadtxt('../data/triangles.txt').astype(np.int32)
# filtered_indexs = np.loadtxt('../data/vertices_500_sel_from_blender.txt').astype(int)
#
# resolution_inp = 256
# resolution_op = 256
