...
config.uv_kpt_ind = '../MyTest/data/uv_kpt_ind.txt'  # 2 x 68 get kpt
config.face_ind = '../MyTest/data/face_ind.txt'  # get valid vertices in the pos map
config.triangles = '../MyTest/data/triangles.txt'
config.filtered_indexs = '../MyTest/data/vertices_520_sel_from_blender.txt'
config.filtered_68_kpt = '../MyTest/data/vertices_68.txt'
config.filtered_kpt_500 = '../MyTest/data/vertices_68_fil_520.txt'
...
config.output_hm_shape = (16, 16, 16)
config.imageNetNorm = False
config.pretrained = True
config.multiscale = False

config.random_round_with_gaussian = True
config.random_round = True
