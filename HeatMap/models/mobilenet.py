...
def mobilenetv2(pretrained=False, **kwargs):
    ...
    config = [
        ...
        (6, 24, 2, 2),
        (6, 32, 3, 2),   #1, 88, 64, 64
        (6, 64, 4, 2),   #1, 120, 64, 64
        (6, 96, 3, 1),   #1, 152, 64, 64
        (6, 160, 3, 2),  #1, 152, 64, 64
        (6, 320, 1, 1)   #1, 152, 64, 64
    ]
...
if __name__ == "__main__":
    ...
    model = mobilenetv2(pretrained=True,
                        model_url="https://www.dropbox.com/s/47tyzpofuuyyv1b/mobilenetv2_1.0-f2a86xx.pth.tar?dl=1")
    a = model(x)
    print(a.shape)
